<div class="p-4">
    <h2 class="text-lg font-semibold text-gray-900 mb-4">Create Customer</h2>

    <form wire:submit="createCustomer" class="space-y-6">
        ...
        <div class="flex gap-3 pt-6 mt-6 border-t border-gray-200">
            <button @disabled($form->hasEmptyFields()) type="submit"
                ...
                <span wire:loading wire:target="createCustomer">Creating...</span>
            </button>

            <button type="button" x-on:click="$dispatch('close-modal'); $wire.resetForm()"
